...
if __name__ == '__main__':
    ...
    # speed 速度
    data = pd.concat([data_train['end'], data_train['speed']], axis=1)
    fig = sns.boxplot(x='speed', y="end", data=data)
    plt.title('speed')
    plt.show()

    # weight 质量
    data = pd.concat([data_train['end'], data_train['weight']], axis=1)
    fig = sns.boxplot(x='weight', y="end", data=data)
    plt.title('weight')
    plt.show()

    # other1
    data = pd.concat([data_train['end'], data_train['other1']], axis=1)
    fig = sns.boxplot(x='other1', y="end", data=data)
    plt.title('other1')
    plt.show()
    ...
    # other3
    data = pd.concat([data_train['end'], data_train['other3']], axis=1)
    fig = sns.boxplot(x='other3', y="end", data=data)
    plt.title('other3')
    plt.show()

    # other4
    data = pd.concat([data_train['end'], data_train['other4']], axis=1)
    fig = sns.boxplot(x='other4', y="end", data=data)
    plt.title('other4')
    plt.show()

    # other5
    data = pd.concat([data_train['end'], data_train['other5']], axis=1)
    fig = sns.boxplot(x='other5', y="end", data=data)
    plt.title('other5')
    plt.show()

    # other6
    data = pd.concat([data_train['end'], data_train['other6']], axis=1)
    fig = sns.boxplot(x='other6', y="end", data=data)
    plt.title('other6')
    plt.show()

    # other7
    data = pd.concat([data_train['end'], data_train['other7']], axis=1)
    fig = sns.boxplot(x='other7', y="end", data=data)
    plt.title('other7')
    plt.show()
